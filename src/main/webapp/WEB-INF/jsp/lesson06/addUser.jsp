...
<%-- AJAX를 사용하려면 jquery 원본 필요 ( 구글 검색 - jquery ) --%>
	...
	<div class="container">
		...
		<form method="post" action="/lesson06/ex01/add_user">
			...
			<div class="form-group">
				...
				<input type="text" id="yyyymmdd" name="yyyymmdd" class="form-control col-3" placeholder="예) 19890104">
			</div>
			<div class="form-group">
	...
	$(document).ready(function() {
		...
		$('#joinBtn').on('click', function() {
			...
			$.ajax({
				// request
				type:"post"  // 키 대문자로 X
				, url:"/lesson06/ex01/add_user"  // view 페이지에 절대 보내지 않음.
